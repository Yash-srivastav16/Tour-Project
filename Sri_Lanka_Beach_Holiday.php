    ...
    <section class="package-details-section" id="package-details">
        <div class="container">
            ...
            <div class="package-header">
                <div class="package-title-section">
                    ...
                    <p class="package-subtitle">Perfect family vacation combining cultural attractions, wildlife experiences, and pristine beach relaxation in 6 unforgettable days</p>
        ...
        <div class="package-overview-section">
            ...
            <p class="overview-description">
                Our Sri Lanka 6-day family tour and beach holiday packages cover all the amazing attractions and activities that will make your Sri Lanka family vacation unforgettable. During this tour, you will enjoy whale watching in Mirissa and watch adorable baby elephants sipping on milk bottles in Pinnawala. Watch the sunset behind the sea while swinging on a hammock in Bentota. Later, take a ride through the aromatic tea gardens in Nuwara Eliya, which will give you a breath of fresh air on your Sri Lanka trip. Our hand-crafted Sri Lanka tour packages offer impeccable service at economical prices.
            </p>
            ...
            <div class="package-highlights">
                <div class="highlight-card">
                    ...
                    <p>Watch adorable baby elephants being fed with milk bottles and taking baths in the river at this breeding ground for wild Asian elephants</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-dharmachakra"></i>
                    </div>
                    <h3>Sacred Temple of Tooth Relic</h3>
                    <p>Visit Kandy's most sacred Buddhist temple housing the tooth relic of Lord Buddha and experience traditional cultural performances</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-leaf"></i>
                    </div>
                    <h3>Tea Gardens & Waterfalls</h3>
                    <p>Journey through aromatic tea gardens in Nuwara Eliya and witness the tea-making process, plus visit majestic Ramboda Waterfalls</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-whale"></i>
                    </div>
                    <h3>Whale Watching Adventure</h3>
                    <p>Early morning whale watching cruise from Mirissa to spot magnificent marine creatures in their natural habitat</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <h3>Beach Paradise & Water Sports</h3>
                    <p>Enjoy pristine beaches in Bentota and Mirissa with variety of water sports including snorkeling, water skiing, and jet scooters</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                    ...
                    <p>Explore the 17th-century Dutch fortifications and visit Sea Turtle Hatchery & Rescue Center for family-friendly experiences</p>
                </div>
            </div>
                </div>
            </div>
        ...
        <section class="special-features-section">
                ...
                <div class="swiper features-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Experience the thrill of spotting magnificent blue whales, sperm whales, and playful dolphins on an early morning cruise in the Indian Ocean</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-whale"></i> Blue Whale Spotting</span>
                                        <span><i class="fas fa-baby"></i> Family Friendly</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="image galary/Alla.jpg" alt="Pinnawala Elephant Orphanage">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Pinnawala Elephant Orphanage</h3>
                                    <p>Watch adorable baby elephants being fed with milk bottles and taking baths in the river at this heartwarming elephant sanctuary and breeding ground</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-elephant"></i> Baby Elephants</span>
                                        <span><i class="fas fa-heart"></i> Conservation</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="image galary/Tea plantation.jpg" alt="Nuwara Eliya Tea Gardens">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Aromatic Tea Gardens</h3>
                                    <p>Journey through rolling hills of Nuwara Eliya's tea plantations, witness traditional tea-making process, and enjoy fresh mountain air</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-mountain"></i> Cool Climate</span>
                                        <span><i class="fas fa-leaf"></i> Tea Tasting</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="image galary/Temple of the tooth.jpg" alt="Temple of Tooth Relic">
                                ...
                                <div class="feature-content">
                                    ...
                                    <div class="feature-stats">
                                        ...
                                        <span><i class="fas fa-temple"></i> Cultural Shows</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="image galary/Galle Fort & Unawatuna Beach.jpg" alt="Galle Fort and Beaches">
                                    <div class="feature-badge">Beach & History</div>
                                </div>
                                <div class="feature-content">
                                    <div class="feature-icon">
                                        <i class="fas fa-umbrella-beach"></i>
                                    </div>
                                    <h3>Galle Fort & Beach Paradise</h3>
                                    <p>Explore the historic Dutch fortification and enjoy pristine beaches with crystal clear waters, perfect for family swimming and relaxation</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-fort-awesome"></i> Historic Fort</span>
            ...
            <div class="quick-itinerary " style="margin-bottom: 6rem;">
                <h3>6-Day Sri Lanka Beach Holiday Overview</h3>
                <div class="itinerary-overview-grid">
                    <div class="overview-day">
                        <div class="day-num">1</div>
                        <div class="day-info">
                            <h4>Arrival & Kandy</h4>
                            <p>Airport pickup, Temple of Tooth Relic, cultural city tour</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">2</div>
                        <div class="day-info">
                            <h4>Pinnawala & Nuwara Eliya</h4>
                            <p>Elephant Orphanage, tea gardens, cool hill station</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">3-4</div>
                        <div class="day-info">
                            <h4>Mirissa Beach Paradise</h4>
                            <p>Whale watching cruise, beach relaxation, water sports</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">5</div>
                        <div class="day-info">
                            <h4>Galle Fort & Bentota</h4>
                            <p>Dutch colonial fort, turtle hatchery, beach activities</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        ...
                        <div class="day-info">
                            ...
                            <p>City shopping tour, cultural sites, airport transfer</p>
                        </div>
                    </div>
                </div>
            </div>
