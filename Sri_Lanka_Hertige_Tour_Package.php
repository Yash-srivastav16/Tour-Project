    ...
    <section class="package-details-section" id="package-details">
        <div class="container">
            ...
            <div class="package-header">
                <div class="package-title-section">
                    ...
                    <p class="package-subtitle">Experience the best of Sri Lanka's cultural heritage, ancient temples, and scenic landscapes in 6 unforgettable days</p>
            ...
            <div class="modern-gallery-section">
                ...
                <div class="tour-gallery-grid">
                    ...
                    <div class="gallery-grid-sidebar">
                        ...
                        <div class="grid-image" onclick="changeMainImage(this, 'image galary/yala1.jpg')">
        ...
        <div class="package-overview-section">
            ...
            <p class="overview-description">
                Embark on an unforgettable journey to explore the best of what Sri Lanka has to offer. Despite being a small country, Sri Lanka boasts a rich culture, heritage, diverse wildlife, and breathtaking beaches. During this 6-day Sri Lankan Heritage Tour, you will visit some of the most prominent sites of the country, such as the Sigiriya Rock Fortress, the Temple of the Tooth Relic in Kandy, and the historic Galle Fort. Enjoy one of the most scenic train rides through the hills, from Kandy to Nanu Oya, near the beautiful garden city of Nuwara Eliya. Take in the natural beauty of Sri Lanka through a safari in Yala National Park. Finally, conclude your trip by exploring the pristine beaches of Unawatuna and the bustling city of Colombo. This heritage tour can be customized as per your request.
            </p>
            ...
            <div class="package-highlights">
                <div class="highlight-card">
                    ...
                    <h3>Ancient Rock Fortress</h3>
                    <p>Climb the iconic Sigiriya Lion Rock with 1,200 steps to discover 5th-century royal palace ruins and stunning frescoes</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-dharmachakra"></i>
                    </div>
                    <h3>Sacred Buddhist Temple</h3>
                    <p>Visit Temple of Sacred Tooth Relic in Kandy, housing Lord Buddha's tooth and witness evening prayer ceremonies</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-train"></i>
                    </div>
                    <h3>World's Most Scenic Train</h3>
                    <p>Journey through misty highlands from Kandy to Nanu Oya, passing tea estates and mountain vistas</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-fort-awesome"></i>
                    </div>
                    <h3>Colonial Galle Fort</h3>
                    <p>Explore UNESCO World Heritage Dutch colonial fort with cobblestone streets and ocean views since 16th century</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-paw"></i>
                    </div>
                    <h3>Leopard Safari Experience</h3>
                    <p>Discover Yala National Park with highest leopard density globally, plus elephants, sloth bears and exotic birds</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <h3>Golden Beach Paradise</h3>
                    <p>Unwind at pristine Unawatuna Beach with golden sands, coral reefs perfect for snorkeling and sunset views</p>
                </div>
            </div>
        </div>
        ...
        <section class="special-features-section">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>A UNESCO World Heritage Site, the ancient royal palace perched atop a towering rock. Known as the "Lion Rock", climb 1,200 steps to the summit for panoramic views, stunning frescoes, and water gardens dating back to the 5th century.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>One of Buddhism's most sacred sites in Kandy, housing the tooth relic of Lord Buddha. Witness traditional rituals performed daily and participate in the evening puja ceremony to see the sacred relic revealed to devotees.</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-pray"></i> Sacred Buddhist Site</span>
                                        <span><i class="fas fa-temple"></i> Daily Ceremonies</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Scenic Train Ride from Kandy</h3>
                                    <p>Experience one of the world's most scenic train rides through Sri Lanka's central highlands. Wind through misty mountains, tea plantations, lush valleys, and witness breathtaking views of waterfalls and terraced tea estates.</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-mountain"></i> Highland Journey</span>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="image galary/unawatuna.jpg" alt="Unawatuna Beach">
                                    <div class="feature-badge">Beach Paradise</div>
                                </div>
                                <div class="feature-content">
                                    <div class="feature-icon">
                                        <i class="fas fa-umbrella-beach"></i>
                                    ...
                                    <p>One of the most beautiful beaches in Sri Lanka, known for its golden sands, crystal-clear waters, and vibrant marine life. Perfect for beachside relaxation, snorkeling in coral reefs, and stunning sunset views over the Indian Ocean.</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-swimming-pool"></i> Crystal Clear Waters</span>
                                        <span><i class="fas fa-fish"></i> Marine Life</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>The second largest park in Sri Lanka with the highest concentration of leopards in the world. Home to elephants, crocodiles, sloth bears, and hundreds of bird species. Experience exciting jeep safari through diverse terrain from dense jungles to open grasslands.</p>
                                    <div class="feature-stats">
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    ...
                                    <div class="feature-badge">Colonial</div>
                                </div>
                                <div class="feature-content">
                                    <div class="feature-icon">
                                        <i class="fas fa-fort-awesome"></i>
                                    ...
                                    <h3>Galle Fort</h3>
                                    <p>A UNESCO World Heritage Site showcasing 16th-century Portuguese and Dutch colonial architecture. This active historical city features colonial charm, quaint shops, galleries, cafes, and the iconic Galle Lighthouse with stunning ocean views.</p>
                                    <div class="feature-stats">
            ...
            <div class="quick-itinerary " style="margin-bottom: 6rem;">
                <h3>6-Day Sri Lankan Heritage Tour Overview</h3>
                <div class="itinerary-overview-grid">
                    <div class="overview-day">
                        <div class="day-num">1</div>
                        <div class="day-info">
                            <h4>Arrival to Sigiriya</h4>
                            <p>Bandaranaike Airport to Sigiriya, hotel accommodation</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">2</div>
                        <div class="day-info">
                            <h4>Sigiriya to Kandy</h4>
                            <p>Rock Fortress climb, Temple of Tooth Relic, cultural show</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">3</div>
                        <div class="day-info">
                            <h4>Scenic Train to Nuwara Eliya</h4>
                            <p>Kandy to Nanu Oya train ride, tea plantations, Adam's Peak views</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">4</div>
                        <div class="day-info">
                            <h4>Nuwara Eliya to Yala</h4>
                            <p>Journey to Yala, Ravana Falls, evening safari</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">5</div>
                        <div class="day-info">
                            <h4>Yala to Galle/Unawatuna</h4>
                            <p>Galle Fort exploration, Unawatuna Beach relaxation</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        ...
                        <div class="day-info">
                            ...
                            <p>City tour, shopping, airport transfer</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const galleryData = [{
            ...
            },
            {
                ...
                description: 'Sri Lanka\'s bustling capital offering a vibrant mix of modernity and colonial history.'
            }
        ];
