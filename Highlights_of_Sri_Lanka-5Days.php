    ...
    <section class="package-details-section" id="package-details">
            ...
            <div class="package-header">
                ...
                <div class="package-price-section">
                    <div class="price-container">
                        ...
                        <div class="discount-badge">Save 21%</div>
                    </div>
            ...
            <div class="modern-gallery-section">
                ...
                <div class="tour-gallery-grid">
                    ...
                    <div class="gallery-grid-sidebar">
                        ...
                        <div class="grid-image" onclick="changeMainImage(this, 'image galary/yala3.jpg')">
                            <img src="image galary/yala3.jpg" alt="Minneriya National Park Elephants">
                            <div class="grid-overlay">
                                <i class="fas fa-paw"></i>
                            </div>
                        </div>

                        <div class="grid-image" onclick="changeMainImage(this, 'image galary/unawatuna.jpg')">
                            <img src="image galary/unawatuna.jpg" alt="Bentota Beach">
                            <div class="grid-overlay">
        ...
        <div class="package-overview-section">
            ...
            <p class="overview-description">
                Discover the mesmerizing beauty of Sri Lanka with our 5-day itinerary. This tour takes you to some of the country's most famous cultural landmarks and natural wonders. Begin your journey by exploring the revered cave temples of Dambulla, followed by a visit to the magnificent rock fortress of Sigiriya. Experience the majestic elephants at Minneriya National Park and relax on the picturesque beaches of Bentota. Finally, conclude your adventure in the beautifully preserved fortified port city of Galle, which boasts a 17th-century Dutch port. Book now and enjoy a 20% discount on this unforgettable experience!
            </p>
            ...
            <div class="package-highlights">
                <div class="highlight-card">
                    ...
                    <p>Experience Dambulla's largest cave temple complex with intricate murals over 2,100 square meters and 14-meter reclining Buddha</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                    ...
                    <p>Climb towering Sigiriya Rock rising 200 meters above plains with royal gardens, Lion's Paw entrance and panoramic summit views</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-paw"></i>
                    ...
                    <p>Enjoy guided jeep safari in Minneriya Park witnessing herds of over 300 elephants gathering around ancient Minneriya Tank</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <h3>Coastal Bliss & Water Sports</h3>
                    <p>Bask on Bentota's white sand beaches, enjoy snorkeling, parasailing, river cruises through mangroves and beachside dining</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon">
                        <i class="fas fa-fort-awesome"></i>
                    </div>
                    <h3>Colonial Charm & History</h3>
                    <p>Stroll through cobblestone streets of Galle Fort with Dutch and Portuguese architecture, lighthouse and ocean views</p>
                </div>
            </div>
        </div>
        ...
        <section class="special-features-section">
                ...
                <div class="swiper features-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Dambulla Cave Temple Complex</h3>
                                    <p>Explore the largest and best-preserved cave temple complex in Sri Lanka with magnificent Buddha statues, ancient murals, and spiritual serenity dating back over 2000 years</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-star"></i> UNESCO World Heritage</span>
                                        <span><i class="fas fa-history"></i> 80 Documented Caves</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Sigiriya Lion Rock Fortress</h3>
                                    <p>Climb the magnificent 5th-century rock fortress with ancient frescoes, water gardens, and panoramic views from the summit of this architectural marvel</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-mountain"></i> 200m High Rock</span>
                                        <span><i class="fas fa-crown"></i> Ancient Royal Palace</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="image galary/yalanat.jpg" alt="Minneriya National Park">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Minneriya Elephant Gathering</h3>
                                    <p>Witness the world's largest Asian elephant gathering where hundreds of elephants converge around Minneriya Tank during the dry season</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-elephant"></i> 300+ Elephants</span>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Walk through cobblestone streets of this 17th-century UNESCO World Heritage fortification with Dutch colonial architecture and stunning ocean views</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-star"></i> UNESCO Heritage</span>
                                        <span><i class="fas fa-lighthouse"></i> Colonial Architecture</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <h3>Bentota Golden Beach</h3>
                                    <p>Relax on pristine golden sands, enjoy water sports activities, and experience the perfect tropical beach paradise on Sri Lanka's southern coast</p>
                                    <div class="feature-stats">
                                        <span><i class="fas fa-water"></i> Water Sports</span>
                                        <span><i class="fas fa-sun"></i> Golden Sands</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="quick-itinerary " style="margin-bottom: 6rem;">
                <h3>5-Day Sri Lanka Highlights Overview</h3>
                <div class="itinerary-overview-grid">
                    <div class="overview-day">
                        <div class="day-num">1</div>
                        <div class="day-info">
                            <h4>Dambulla & Sigiriya</h4>
                            <p>Cave temple complex exploration, check-in at Sigiriya</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        <div class="day-num">2</div>
                        <div class="day-info">
                            <h4>Sigiriya Rock & Minneriya</h4>
                            <p>Ancient fortress climb, elephant safari in Minneriya Park</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        ...
                        <div class="day-info">
                            ...
                            <p>Temple of Sacred Tooth Relic, traditional village visit</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        ...
                        <div class="day-info">
                            <h4>Bentota Beach</h4>
                            <p>Golden beaches, water sports, coastal relaxation</p>
                        </div>
                    </div>
                    <div class="overview-day">
                        ...
                        <div class="day-info">
                            ...
                            <p>Dutch fort exploration, Unawatuna Bay, airport transfer</p>
                        </div>
                    </div>
                </div>
            </div>
